...
<label class="col-md-0 control-label" for="="><h4>Data Bayi</h4></label>
  ...
  <div class="form-group">
    ...
    <!-- <div class="form-group">
      ...
      <div class="col-md-9">
      <?php if ($data_kelahiran[0]['is_kembar'] == 'Y'){ ?>
        <div class="radio">
          <label class="radio"><input type="radio" name="is_kembar" value="Y" checked="checked"> Ya</label>
        </div>
        <div class="radio">
          <label class="radio"><input type="radio" name="is_kembar" value="N"> Tidak</label>
        </div>
        <?php } else {?>
        <div class="radio">
          <label class="radio"><input type="radio" name="is_kembar" value="Y"> Ya</label>
        </div>
        <div class="radio">
          <label class="radio"><input type="radio" name="is_kembar" value="N" checked="checked"> Tidak</label>
        </div>
        <?php } ?>
      </div>
    </div> -->
  ...
  <legend></legend>
    ...
    <div class="form-group">
       ...
       <select class="form-control selectlive" name="lokasi_lahir" required>
        <option value="<?php echo $data_kelahiran[0]['lokasi_lahir'] ?>" selected><?php echo $data_kelahiran[0]['lokasi_lahir'] ?></option>
